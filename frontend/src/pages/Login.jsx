...
import GoogleOidc from "../components/GoogleOidc";
...
export default function Login() {
  ...
  return (
    <>
      <div
        className={`fixed top-5 left-1/2 -translate-x-1/2 px-6 py-3 rounded-lg shadow-lg text-white text-sm font-medium transition-all duration-500 z-50
